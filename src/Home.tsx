                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://discord.com/invite/bearwithus"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        Okay Bears is a culture shift. A clean collection of
                                                        10,000 diverse bears building a virtuous
                                                        community that will transcend the internet into the
                                                        real world.
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (9300/10000)
                          </span>
                        </div>
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                                                                href="https://www.okaybears.com/blueprint"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                In a polar world of winners and losers, heroes
                                                                and villains, artists and builders, the middle
                                                                ground has been left barren. That very ground
                                                                lays the foundation of The Park, where it is okay
                                                                to be okay.

                                                                An immaculate collection of 10,000 diverse
                                                                bears that grant you exclusive access to The
                                                                Park, where together, we build a virtuous
                                                                community that will transcend the internet into
                                                                the real world.

                                                                Through meaningful member-only merch drops,
                                                                outdoor campaigns, exclusive live events and
                                                                collaborations with indie businesses and world-
                                                                renowned brands, we create a community-
                                                                centric, globally recognised brand that is a force
                                                                for good.
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        We’re not just releasing a roadmap; we’re laying out the blueprint
                                                                        to help guide and build a community-centric, world-leading web
                                                                        three brand.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        We're building an ecosystem of commercial channels spanning
                                                                        across web three, web two and IRL, through partnerships with
                                                                        brands like @MagicEden and @Shopify. Your Okay Bear will give
                                                                        you exclusive access to digital and physical merch, products and
                                                                        events.
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        We will grow the Okay Bears brand through online guerrilla
                                                                        marketing (eg: #WeAreOkay & #BearWithUs) & outdoor
                                                                        advertising campaigns in the weeks following mint. We will also
                                                                        auction 1 of 1 Okay Bears for world-changing causes and high-
                                                                        visibility collabs.
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Through our team's experience in digital and physical keynotes &
                                                                        conferences, we will celebrate the great work of the entire SOL
                                                                        NFT community. We will also offer community grants and
                                                                        copyright licensing to outstanding Okay Bears community artists
                                                                        & initiatives.
                            </p>
                            <br />
                          </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        mixtapes and other forms of collective artistic expression. We
                                                                        will continue to create gorgeous concept art and beautifully
                                                                        written folk tales... And future holder-only NFT drops.
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Our website will display all 10,000 Okay Bears for the world to
                                                                        marvel at. We will also curate a gallery of our favourite fan art
                                                                        and the artists behind it, as well as work with other NFT brands
                                                                        and artists to bring our digital art to physical galleries & exhibits.
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        The Okay Bears collection has been designed with glorious
                                                                        streetwear in mind. Through our token-gated online store,
                                                                        holders will gain exclusive access to merch, collectibles and
                                                                        collab items with leading fashion, lifestyle and sports brands.
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        At the core of Okay Bears is a digital space built in the middle
                                                                        ground of the metaverse, where it is okay to be okay. Our digital
                                                                        home is our Discord, where chill and good vibes replace grind
                                                                        and conflict.
                                                                    </p>
                                                                    <br />
                                                                </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        Our brand is built through community. As we grow, so will our
                                                                        blueprint. We're excited to see just how far we can take Okay
                                                                        Bears.


                                                                        Bear with us, we're building this thing together.


                                                                        WAGBO - We're all gonna be okay.
                                                                    </p>
                                                                    <br />
                                                                </div>
